...
export const phase1EnvelopeFixture = {
  ...
  bpmOctaveEvidence: {
    candidates: [
      { bpm: 128, ratio: '1:1', lowbandScore: 1.0, fullbandScore: 1.0, score: 2.0 },
      { bpm: 192, ratio: '3:2', lowbandScore: 0.2, fullbandScore: 0.1, score: 0.3 },
      { bpm: 64, ratio: '1:2', lowbandScore: 0.5, fullbandScore: 0.0, score: 0.5 },
    ],
    preferredBpm: 128,
    preferredRatio: '1:1',
    supportsShipped: true,
    dominance: 4.0,
    lowbandIoiCount: 31,
    fullbandIoiCount: 63,
  },
